            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="dropdown-item" href="agreStock.php">Agregar stock</a></li>
            ...
            <div class="col-2">
              <div class="card" style="width: 18rem;margin-left: 30%;">
                <h5 class="card-title" class="form-label">
                  <label for="disabledSelect" class="form-label">ID: '. $row['id'].'</label>
                </h5>
                <h5 class="card-title" class="form-label">
                  <label for="disabledSelect" class="form-label">ID del Empleado: '.$row['id_empleado'].'</label>
                </h5>
                <h5 class="card-title" class="form-label">
                  <label for="disabledSelect" class="form-label">ID del Producto: '.$row['id_producto'].'</label> 
                </h5>
                <h5 class="card-title" class="form-label">
                  <label for="disabledSelect" class="form-label">Facha del agregado: '.$row['fecha'].'</label>        
                </h5>
                <h5 class="card-title" class="form-label">
                  <label for="disabledSelect" class="form-label">Stock: '.$row['stock'].'</label>        
                </h5>
              </div>
            </div>';
          }
